...
public class GeoFieldsTest {
   ...
   public void convertCoordinates() {
      // degree coded
      DataField testDataField = TestHelper.dataFieldFactory(null, new SolrInputDocument(), "034", "0", "http://sws.geonames.org/3103556");
      ...
      Collection<Object> result = testDataField.solrDoc.getFieldValues("coordinates");
   ...
   public void sameAsCoordinates() {
      ...
      GeoFields.coordinates(testDataField);
      // reference
      Collection<Object> result = testDataField.solrDoc.getFieldValues("sameAs");
      assertTrue("URL to geonames should exist.", (result != null));
      assertTrue("The URL should be 'http://sws.geonames.org/3103556'.", result.contains("http://sws.geonames.org/3103556"));
   }
   ...
   public void getCoding() {
      DataField testDataField = TestHelper.dataFieldFactory(null, new SolrInputDocument(), "034", "9", "A:agx");
      assertTrue("'a' is expected." , ('a' == GeoFields.getCoding(testDataField)));
      testDataField = TestHelper.dataFieldFactory(null, new SolrInputDocument(), "034", "9", "A:d");
      assertTrue("'d' is expected." , ('d' == GeoFields.getCoding(testDataField)));
      testDataField = TestHelper.dataFieldFactory(null, new SolrInputDocument(), "034", "d", "N 054 00'25");
      assertTrue("'a' should be detectet." , ('a' == GeoFields.getCoding(testDataField)));
      testDataField = TestHelper.dataFieldFactory(null, new SolrInputDocument(), "034", "d", "N 054.0025");
